AppModule.directive('feedbackTab', feedbackTabFunc);
AppModule.factory('IWFeedbackService', IWFeedbackService);
...
function feedbackTabFunc(IWSettingService, IWObjService ,IWFeedbackService,$mdDialog) {
    return {
        restrict: 'E',
        templateUrl:  '/sites/all/modules/idea_widget/components/directives/feedback-tab/feedback-tab.html',
        replace: false,
        scope: false,
