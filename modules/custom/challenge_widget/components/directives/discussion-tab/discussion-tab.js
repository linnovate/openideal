AppModule1.directive('discussionTab', discussionTabFunc);
...
AppModule1.directive('ngElementReady',ngElementReady);
ngElementReady.$inject = [];
function discussionTabFunc(IWSettingService, IWObjService ,$mdDialog) {
    return {
        restrict: 'E',
        templateUrl:  '/sites/all/modules/challenge_widget/components/directives/discussion-tab/discussion-tab.html',
        replace: false,
        scope: false,
