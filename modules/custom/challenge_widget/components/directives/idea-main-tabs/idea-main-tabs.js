AppModule1.directive('ideaMainTabs', ideaMainTabsFunc);
ideaTabsFunc.$inject = ['IWSettingService', 'IWObjService'];

function ideaMainTabsFunc(IWSettingService, IWObjService) {
    return {
        restrict: 'E',
        templateUrl:  '/sites/all/modules/challenge_widget/components/directives/idea-main-tabs/idea-main-tabs.html',
        replace: false,
        scope: false,
